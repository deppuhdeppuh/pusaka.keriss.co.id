  ...
  <head>
    ...
    <style type="text/css">
      ...
      body{
        ...
        color: red;
        text-align: center;
        background-image: url(https://www.kibrispdr.org/data/matrix-gif-4.jpg);
    ...
    <div class="container">
        <div class="row">
                <div class="col-md-12 d-flex justify-content-center">
                    <img src="https://l.top4top.io/p_2212ctnx41.png" class="img-fluid mt-1" align="center">
                </div>
                ...
                <div class="col-md-12">
                    <blink> <h1><font color="white">NOT FOUND</font></h1></blink>
                </div>
                <div class="col-md-6">
                    <h3><font color="red">R2G Cyb</font><font color="white">er Team</font></h3>
                </div>
                <div class="col-md-6">
                    <h3><font color="white">PANDEGLANG</font> <font color="red">BLACKHAT</font></h3>
                </div>
                <hr>
        </div>
    </div>
